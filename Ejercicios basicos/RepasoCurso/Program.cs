    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            // se evalua como: a ? b : (c ? d : e) 
            // nameVariable = variable + codicion + ? + "si es true" + : + "si es false"

            int stemperatura = -5;
            string stadodelagua;

            stadodelagua = stemperatura < 0 ? "solido" : "Liquido";
            Console.WriteLine($"{stadodelagua}");

            // con else if

            stadodelagua = stemperatura > 99 ? "gaseoso" : stemperatura < 0 ? "solido" : "liquido"; 
