...
namespace Desafio1
{
    class Program
    {
        ...
        // Metodo que asigna los valores al Array
        public static void AsignarXoO(int jugador, int ingreso)
        {
            char signo = ' ';
            if (jugador == 1) { signo = 'X'; } else if (jugador == 2) { signo = 'O'; }
            switch (ingreso)
            {
